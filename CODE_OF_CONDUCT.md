...
the Cortera Framework community a harassment-free experience for everyone,
...
- Trolling and deliberately inflammatory or off-topic behavior
...
1. **Correction** — Private warning, clarity on the violation.
2. **Warning** — Warning with consequences for continued behavior.
3. **Temporary Ban** — Temporary ban from any interaction with the project.
4. **Permanent Ban** — Permanent ban from any public interaction with the
   project.
